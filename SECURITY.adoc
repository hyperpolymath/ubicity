...
[arabic]
. *Email*: See `+.well-known/security.txt+` for contact information
...
* *Permissions*: explicit permissions (`+--allow-read+`,
`+--allow-write+`)
...
If a CVE is assigned: 1. Acknowledgment within 24 hours 2. Patch
development within 7-14 days 3. Security update release 4. Advisory on
GitHub Security 5. CHANGELOG.md update
