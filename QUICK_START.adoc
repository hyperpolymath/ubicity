...
Answer the prompts: - *Learner ID*: your-pseudonym - *Location*: Local
Coffee Shop - *Type*: reading - *Description*: Learned about urban
planning - *Domains* (optional): urban-planning, architecture
...
If yes: UbiCity works for you. Keep using it. If no: That’s okay. At
least you know.
...
Need Node.js v18+ installed. Check: `+node --version+`
