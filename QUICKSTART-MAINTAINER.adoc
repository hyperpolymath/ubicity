...
This guide covers packaging, deploying, and maintaining ubicity for
...
| `$PREFIX/share/ubicity/`
| Data files, assets

| `$PREFIX/share/doc/ubicity/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/ubicity/config.toml`

Fallback: `$HOME/.config/ubicity/config.toml`
...
Or via OPSM: `opsm update ubicity`
...
[source,bash]
----
just install --prefix=/opt/ubicity-instance1 --config=/etc/ubicity/instance1.toml
just install --prefix=/opt/ubicity-instance2 --config=/etc/ubicity/instance2.toml
----
...
* Upstream: https://github.com/hyperpolymath/ubicity/issues
