...
[source,]
----
//  type system enforces this seam ✓
...
- Data layer: `src-/Decoder.res`, `src-/Mapper.res` (storage)
- Analysis layer: `src-/Analysis.res`, `src-/Mapper.res` (queries)
- Domain types: `src-/UbiCity.res`
