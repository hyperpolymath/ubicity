...
:experimental:
:url-github: https://github.com/hyperpolymath/UbiCity
:url-gitlab: https://gitlab.com/hyperpolymath/UbiCity
:url-bitbucket: https://bitbucket.org/hyperpolymath/UbiCity
:url-codeberg: https://codeberg.org/hyperpolymath/UbiCity

Ubiquitous city computing platform
...
UbiCity is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
